...
enum TestCardNumbers {
    enum ValidationError {
        ...
        static let invaldExpiryMonth = "4532873294814636"
        ...
        static let all = [invalidNumber, invaldExpiryMonth, invalidExpiryYear, invalidCVC, expiredCard]
    }
...
@objc class TestCardNumbersObjC: NSObject {
    @objc static let visa = TestCardNumbers.visa
    @objc static let frictionlessPassing = TestCardNumbers.VisaThreeD.frictionlessPassing
    @objc static let frictionlessFailing = TestCardNumbers.VisaThreeD.frictionlessFailing
}
