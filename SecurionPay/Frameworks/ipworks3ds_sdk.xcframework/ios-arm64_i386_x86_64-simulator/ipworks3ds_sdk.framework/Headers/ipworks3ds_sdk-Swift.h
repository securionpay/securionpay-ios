...
SWIFT_CLASS("_TtC14ipworks3ds_sdk34CompletionEventASIdentifierManager")
@interface CompletionEventASIdentifierManager : NSObject <ThreadValue>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)deviceParamIndexDyldInfoCmd:(NSData * _Null_unspecified)dataPacket;
- (void)stringWhyInformationText:(NSData * _Null_unspecified)dataPacket;
- (void)whitespacesAndNewlinesNameA:(int32_t)errorCode :(NSString * _Null_unspecified)description;
- (void)implementationSimulator:(int32_t)logLevel :(NSString * _Null_unspecified)message :(NSString * _Null_unspecified)logType;
- (void)lazyBindInfoCmdParamValue:(NSData * _Null_unspecified)certEncoded :(NSString * _Null_unspecified)certSubject :(NSString * _Null_unspecified)certIssuer :(NSString * _Null_unspecified)status :(int32_t * _Nonnull)accept;
- (void)frameworkSelector:(NSString * _Null_unspecified)message;
@end
...
SWIFT_CLASS("_TtC14ipworks3ds_sdk17LoadDSCertsBundle")
@interface LoadDSCertsBundle : NSObject
+ (void)contentsColor;
+ (void)getBackgroundColorShouldStop;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
